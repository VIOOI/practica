...
set shortmess=aoO
badd +5 ~/Documents/code/ReactJs/practica/src/store/store.js
badd +6 ~/Documents/code/ReactJs/practica/src/store/users/userSlice.js
badd +12 ~/Documents/code/ReactJs/practica/src/index.js
argglobal
%argdel
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit ~/Documents/code/ReactJs/practica/src/store/store.js
argglobal
balt ~/Documents/code/ReactJs/practica/src/store/store.js
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
normal! 0
tabnext
edit ~/Documents/code/ReactJs/practica/src/store/users/userSlice.js
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
